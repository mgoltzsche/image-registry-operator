...
func testAuthentication(t *testing.T, cr, user, pw string, expectedLabels map[string][]string, auth func(t *testing.T, ns, usr, pw string, succeed bool) map[string][]string) {
